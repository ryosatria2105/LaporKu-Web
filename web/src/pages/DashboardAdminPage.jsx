              ...
              <div style={{ display:"flex", flexDirection:"column", gap:"0", fontFamily:"-apple-system, BlinkMacSystemFont, 'SF Pro Text', 'Helvetica Neue', sans-serif" }}>
                ...
                <SCard>
                  {[
                    ...
                    { label:bahasa==="en"?"Institution":"Institusi", val:"Webora Dev", icon:<svg width="16" height="16" fill="none" viewBox="0 0 24 24" stroke={DK.dimtext} strokeWidth={2}><path d="M3 9l9-7 9 7v11a2 2 0 01-2 2H5a2 2 0 01-2-2z"/><polyline points="9 22 9 12 15 12 15 22"/></svg>  },
