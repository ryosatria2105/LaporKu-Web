    ...
    <div className="auth-page">
      ...
      <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', width: '100%' }}>
        ...
        {import.meta.env.VITE_DEMO_MODE === 'true' && (
          <div style={{ width: '100%', maxWidth: '860px', marginBottom: '10px', textAlign: 'center' }}>
            <button
              type="button"
              onClick={() => setShowDemo(v => !v)}
              style={{ background: 'none', border: 'none', cursor: 'pointer', color: '#64748B', fontSize: '13px', display: 'inline-flex', alignItems: 'center', gap: '6px', padding: '6px 0' }}
            >
              Lihat panduan demo {showDemo ? '▲' : '▼'}
            </button>
            ...
            <div className="auth-form-wrap">
              ...
              <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '14px' }}>
                ...
                <div style={{ textAlign: 'right', marginTop: '-6px' }}>
                  {import.meta.env.VITE_DEMO_MODE === 'true'
                    ? <span className="auth-forgot" style={{ color: '#9CA3AF', cursor: 'default' }}>Lupa kata sandi? (nonaktif)</span>
                ...
                {import.meta.env.VITE_DEMO_MODE === 'true' && (
                  <div style={{ display: 'flex', gap: '8px', marginTop: '8px' }}>
                    <button
                      type="button"
                      onClick={() => setForm({ login: 'admin_demo', password: 'demo12345' })}
                      className="auth-btn"
                    ...
                    <button
                      type="button"
                      onClick={() => setForm({ login: 'warga_demo', password: 'demo12345' })}
                      className="auth-btn"
                      style={{ flex: 1, background: '#F1F5F9', color: '#1E293B', border: '1px solid #E2E8F0' }}
                    >
